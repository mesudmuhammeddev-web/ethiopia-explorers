...
const navMenu: NavEntry[] = [
  {
    ...
    items: [
      ...
      { label: "Southern Omo Valley", href: "/experiences/omo-valley" },
      { label: "Danakil Depression", href: "/experiences/danakil-depression" },
      { label: "Simien Mountains Trekking", href: "/experiences/simien-trekking" },
      { label: "Bale Mountains & Highlands", href: "/experiences/bale-highlands" },
      { label: "Harar & Eastern Ethiopia", href: "/experiences/harar-eastern" },
      { label: "Grand Combined Tours", href: "/experiences/grand-combined" },
    ],
  },
  {
    key: "tours",
    ...
    items: [
      ...
      { label: "Day Trips from Addis", href: "/services/day-trips-addis" },
      { label: "Car Rental with Driver", href: "/services/car-rental" },
      { label: "Group vs Private Tours", href: "/services/group-vs-private" },
